...
import 'package:damaged303/app/modules/profile/UploadData/uploadDataView.dart';
import 'package:damaged303/app/modules/profile/profile_controller.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          GestureDetector(
            ...
            onTap: () {
              Get.to(UploadDataView())?.then((_) {
                // Refresh profile when coming back from upload page
